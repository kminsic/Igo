...
public class MyPageController {
    ...
    // 내가 쓴 post 불러오기
    @RequestMapping(value = "/api/member/post", method = RequestMethod.GET)
    public ResponseDto<?> getPost(HttpServletRequest request) {
        return myPageService.getPost(request);
    }
    // 나의일정 불러오기
    @RequestMapping(value = "/api/member/mypost", method = RequestMethod.GET)
    ...
    //회원정보 수정하기
    @PutMapping("api/auth/member/mypage")
    public ResponseDto<?> updateMember(HttpServletRequest request,@RequestPart("profileimage") MultipartFile file,
