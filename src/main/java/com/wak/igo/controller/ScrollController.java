...
public class ScrollController {
    ...
    // 최신순 게시글 스크롤 페이지네이션
    @RequestMapping(value = "/api/post/create/articles", method = RequestMethod.GET)
    ...
    // 조회순 게시글 스크롤 페이지네이션
    @RequestMapping(value = "/api/post/view/articles", method = RequestMethod.GET)
    ...
    // 좋아요순 게시글 스크롤 페이지네이션
    @RequestMapping(value = "/api/post/heart/articles", method = RequestMethod.GET)
